...
void my_printerr_char_arr(va_list args, char *formater);

static const char *form_terminator = "sdicfeEgGbSuoxXC";
static const int len_form_list = 16;
