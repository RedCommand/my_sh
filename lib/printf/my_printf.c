...
void my_printf_char_arr(va_list args, char *formater);
void my_printf_show_char_arr(va_list args, char *formater);

static const char *form_terminator = "sdicfeEgGbSuoxXCP";
static const int len_form_list = 17;
